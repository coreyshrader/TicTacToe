...
public class TTTClient {
    ...
    static private char[][] board = {{' ', ' ', ' '},
                                    {' ', ' ', ' '},
                                    {' ', ' ', ' '}};
    static private DataInputStream instream;
    static private DataOutputStream outstream;
    static private Socket toserversocket;
    static private int reply;   // for later use
